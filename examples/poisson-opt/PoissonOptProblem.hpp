...
public:
   ...
   *
   * @param[in] control - Optimized boundary control.
   * @param[in] state - State generated by `control`.
   * @param[in] val - Reduced-objective value.
   * @param[in] grad - Reduced gradient.
   * @return Final optimization metrics.
   */
  Report report(const HostVector<Real>& control,
   ...
   */
  void writeSolution(const HostVector<Real>& control,
                     const HostVector<Real>& state,
...
private:
  ...
  void writeFields(const HostVector<Real>& control,
                   const HostVector<Real>& state,
