...
void requireReSolve(const SolverParams& solver)
{
  ...
  {
    throw runtime_error(
        string(FEMX_NAVIER_VAR_NEW_APP_NAME)
...
ReSolveOptions makeReSolveOptions(const SolverParams& solver)
{
  ReSolveOptions opts;
...
void configOptimizer(TaoOptimizer& optimizer, const OptimizerParams& opts)
{
...
void printFinalSummary(const TaoResult& result, const TimeTrajectory& tr)
{
  cout << "\nFinal summary\n";
