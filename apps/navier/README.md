...
PETSc uses Host assembly and exact distributed preallocation. In a CUDA
ReSolve build, the trajectory, residual, Jacobian, boundary work, and linear
solve remain on Device. Both paths evaluate the same Navier--Stokes element
operator.
