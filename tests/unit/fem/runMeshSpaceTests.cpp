...
template <std::size_t N>
bool indexValuesEqual(const HostVector<Index>&    actual,
...
TestOutcome observationGridFromBounds()
{
  ...
  const HostVector<Point3> pts = fem::observationGridPoints(
      Point3{0.0, 10.0, -1.0},
      Point3{2.0, 20.0, 1.0},
  ...
  const HostVector<Point3> center = fem::observationGridPoints(
      Point3{-2.0, 2.0, 10.0},
      Point3{2.0, 6.0, 14.0},
